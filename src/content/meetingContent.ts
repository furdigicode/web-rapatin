...
export const meetingHeroContent: HeroContent = {
  ...
  title: 'Alternatif <span class="text-primary">Zoom Meeting</span> bayar per pemakaian. Tanpa Langganan.',
  subtitle:
  ...
  features: [
    {
      ...
      description:
        "Top up saldo akun Anda dan bayar hanya untuk rapat yang Anda jadwalkan. Tanpa langganan bulanan atau biaya tersembunyi.",
      delay: "delay-0",
    },
    {
    ...
    },
    {
      ...
      description:
        "Nikmati akses penuh ke semua fitur premium seperti polling, ruang diskusi, tanya jawab, dan berbagi layar tanpa batasan.",
      delay: "delay-500",
    },
  ],
  useCases: {
