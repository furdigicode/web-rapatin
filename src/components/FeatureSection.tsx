...
const Feature: React.FC<FeatureProps> = ({
  ...
  return <div className={`glass p-6 rounded-xl transition-all duration-300 hover:shadow-elevation animate-fade-in ${delay}`}>
  ...
  return <section id="features" className="py-20 bg-gradient-to-b from-background to-accent/20">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => <Feature key={index} icon={feature.icon} title={feature.title} description={feature.description} delay={feature.delay} />)}
        </div>
        ...
        <div className="mt-20 max-w-3xl mx-auto glass p-8 rounded-xl animate-fade-in shadow-soft">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="flex flex-col items-center text-center p-4 rounded-lg hover:bg-accent/50 transition-colors">
              ...
              <p className="font-medium text-sm">Komunitas</p>
            </div>
            <div className="flex flex-col items-center text-center p-4 rounded-lg hover:bg-accent/50 transition-colors">
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mb-3 text-primary">
                <UserCheck size={18} />
