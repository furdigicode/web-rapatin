...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="pt-24 pb-12 md:pt-28 md:pb-20 bg-hero-pattern flex flex-col items-center w-full">
      <div className="container flex flex-col items-center px-4 md:px-6 max-w-2xl w-full">
        ...
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-foreground text-center mb-4 animate-fade-in">
      ...
      <div className="w-full flex justify-center animate-fade-in mb-10">
        <div className="flex flex-row flex-wrap items-center justify-center w-full max-w-4xl bg-white/80 border-2 border-blue-300 rounded-xl shadow-md py-6 px-2 sm:px-8 gap-6 md:gap-12">
          <div className="flex items-center gap-3 text-base font-medium min-w-[160px] justify-center">
            <BadgeDollarSign size={22} className="text-primary" />
            <span>Bayar Setiap Rapat</span>
          </div>
          <div className="flex items-center gap-3 text-base font-medium min-w-[180px] justify-center">
            <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" className="text-primary" viewBox="0 0 24 24"><rect x="2" y="7" width="20" height="10" rx="2"/><path d="M22 17v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2"/></svg>
          ...
          <div className="flex items-center gap-3 text-base font-medium min-w-[180px] justify-center">
            <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" className="text-primary" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
            <span>Durasi Tidak Terbatas</span>
          </div>
        </div>
      </div>
      <div className="w-full flex justify-center animate-slide-in-right mb-2">
        <img 
          src={IllustSrc} 
      ...
      <div className="mt-3 md:mt-8 w-full">
