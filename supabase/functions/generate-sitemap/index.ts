...
serve(async (req) => {
  ...
  try {
    ...
    const sitemapLines: string[] = [
      ...
      '  </url>',
      '  <url>',
      '    <loc>https://rapatin.id/event-management</loc>',
      `    <lastmod>${currentDate}</lastmod>`,
      '    <changefreq>monthly</changefreq>',
      '    <priority>0.9</priority>',
      '  </url>',
      '  <url>',
      '    <loc>https://rapatin.id/meeting-scheduling</loc>',
      `    <lastmod>${currentDate}</lastmod>`,
      '    <changefreq>monthly</changefreq>',
      '    <priority>0.9</priority>',
      '  </url>',
      '  <url>',
      '    <loc>https://rapatin.id/appointment</loc>',
      `    <lastmod>${currentDate}</lastmod>`,
      '    <changefreq>monthly</changefreq>',
      '    <priority>0.9</priority>',
      '  </url>',
    ...
    sitemapLines.push(
      ...
      '  </url>',
      '  <url>',
      '    <loc>https://rapatin.id/feedback</loc>',
      `    <lastmod>${currentDate}</lastmod>`,
      '    <changefreq>monthly</changefreq>',
